...
export default function ServicePage ({data}) {
	...
	return (
		...
		<>
			...
			<div dangerouslySetInnerHTML={{__html:data?.page?.servicePages?.leftParagraph}}/>
			<div dangerouslySetInnerHTML={{__html:data?.page?.servicePages?.rightParagraph}}/>
			</LeftRightParagraphsStyles>
			...
			<div dangerouslySetInnerHTML={{__html:data?.page?.servicePages?.aboveFooterLeft}}/>
			</LeftRightParagraphsStyles>

			<LeftRightParagraphsStyles className="bottom right">
			<div dangerouslySetInnerHTML={{__html:data?.page?.servicePages?.aboveFooterRight}}/>
			</LeftRightParagraphsStyles>

			<AboveServiceFooterContainer>
			<div className="content" dangerouslySetInnerHTML={{__html:data?.page?.servicePages?.footerText}}/>
			<div>
